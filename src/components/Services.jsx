...
export default function Services() {
  ...
  return (
    <section id="servicios" className="relative py-24 lg:py-32 overflow-hidden isolate bg-slate-50" style={{ WebkitTransform: 'translateZ(0)' }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-blue-accent/40 hover:shadow-xl hover:shadow-blue-accent/5 transition-all duration-500"
            >
              {/* Image */}
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="font-[var(--font-heading)] text-xl font-bold text-slate-800 mb-3 group-hover:text-blue-accent transition-colors">
                  {service.title}
                </h3>
